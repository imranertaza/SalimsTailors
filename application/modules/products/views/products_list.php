...
<div class="box">
		...
		<th>Action</th>
			...
			<td width="180px">
				<?php 
				echo anchor(site_url('products/read/'.$products->pro_id),'View', 'class="btn btn-xs btn-info"'); 
				echo ' '; 
				echo anchor(site_url('products/update/'.$products->pro_id),'Update', 'class="btn btn-xs btn-warning"'); 
				echo ' '; 
				echo anchor(site_url('products/delete/'.$products->pro_id),'Delete', 'class="btn btn-xs btn-danger"', 'onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
